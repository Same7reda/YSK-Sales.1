...
import { BellIcon, PackageIcon, UsersIcon, TruckIcon, CalendarIcon, AlertTriangleIcon } from './icons';
        ...
        <header className="bg-gray-50/80 backdrop-blur-sm w-full py-4 px-8 flex items-center justify-between sticky top-0 z-30 border-b border-gray-200">
            ...
            <div className="flex items-center gap-6">
                 {currentUser?.permissions.canUseAssistant && (
                    <button onClick={onToggleAssistant} title="مساعد YSK" className="relative text-gray-500 hover:text-gray-800 transition-transform duration-200 hover:scale-110">
                        <img src="https://i.postimg.cc/D0cf0y0m/512-x-512-1.png" alt="YSK Assistant" className="w-8 h-8"/>
                    </button>
                 )}
